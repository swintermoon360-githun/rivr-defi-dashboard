  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="bg-[rgba(30,50,90,0.05)] w-10 h-10 md:w-14 md:h-14 rounded-full flex items-center justify-center border border-[rgba(30,50,90,0.1)] cursor-pointer flex-shrink-0"
      >
